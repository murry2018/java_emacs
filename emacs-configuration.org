...
** LSP C/C++ Support
LSP supports C/C++ too. Here I will use [[https://clangd.llvm.org/][clangd]]. Because LSP for c/c++ doesn't provide automatic language server installation, you should manually install them. To install a language server, follow the [[https://clangd.llvm.org/installation.html][Getting Started Guide]].
...
'Project Setup' section in [[https://clangd.llvm.org/installation.html][Getting started guide]] must be helpful.
